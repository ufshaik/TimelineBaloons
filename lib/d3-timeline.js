...
(function () {
  d3.timeline = function() {
    ...
    var hover = function () {},
        ...
        // Custom
        tickFormat = { format: d3.time.format("%d-%b-%y"),
    ...
    function timeline (gParent) {
        ...
        d.forEach( function(datum, index){
          ...
          g.selectAll("svg").data(data).enter()
              ...
              .style("fill", function(d, i){
                ...
                labelled_colors.push(colorCycle(index));
          ...
          if (showLines)
          {
          // Custom Append vertical Lines
          g.selectAll("svg").data(data).enter()
              .append("line")
              .attr("x1", getXPos)
              .attr("y1",getStackPosition)
              .attr("x2",getXPosLine)
              .attr("y2",getStackPositionCircle)
              .attr("class", "dashed")
          ...
          if (showCircles)
          {
          // Custom Append circles
          g.selectAll("svg").data(data).enter()
              .append("circle")
              .attr("cx", getXPos)
              .attr("cy",getStackPositionCircle)
              .attr("r", 4)
              .attr("class", function (d, i) {
                return datum.class ? "intenseSeries_"+datum.class : "intenseSeries_"+index;
              })
          ...
          // Custom
          function getStackPositionCircle(d, i) {
            if (stacked) {
              return margin.top + (itemHeight + itemMargin) * yAxisMapping[index];
            }
      ...
      // console.log(labelled_colors);
      // console.log(Array.from(new Set(labelled_colors)));
    ...
    timeline.lines = function () {
      showLines = !showLines;
      return timeline;
    };
    timeline.circles = function () {
